    ...
    return (
        <div className={styles.detail}>
            <div className={styles.topBar}>
                <Link to='/home'>
                    <input className={styles.pokemonImg} type="Image" src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/98/International_Pok%C3%A9mon_logo.svg/1200px-International_Pok%C3%A9mon_logo.svg.png"/>
                </Link>
            ...
            <div className={styles.divider}/>
            {
                ...
                <div className={styles.pokemon}>
                    ...
                    <img src={myPokemon.img} alt="" width="500px" height="550px"/>
